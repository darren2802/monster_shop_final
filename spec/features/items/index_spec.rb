...
RSpec.describe 'Item Index Page' do
  describe 'As a visitor' do
    before :each do
      ...
      @nessie = @brian.items.create!(name: 'Nessie', description: "I'm a Loch Monster!", price: 5000, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: false, inventory: 3 )
    ...
    it 'I can see a list of all active items' do
      ...
      within "#item-#{@hippo.id}" do
        ...
        expect(page).to have_content("Price: #{number_to_currency(@hippo.price / 100)}")
        expect(page).to have_content("Active")
