...
RSpec.describe 'Order Show Page' do
  describe 'As a Registered User' do
    before :each do
      ...
      @ogre = @megan.items.create!(name: 'Ogre', description: "I'm an Ogre!", price: 2025, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: true, inventory: 5 )
      ...
      @hippo = @brian.items.create!(name: 'Hippo', description: "I'm a Hippo!", price: 5000, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: true, inventory: 1 )
    ...
    it 'I see order information on the show page' do
      ...
      within "#order-created" do
        expect(page).to have_content(@order_2.created_at.strftime('%F'))
      end
      within "#order-updated" do
        expect(page).to have_content(@order_2.updated_at.strftime('%F'))
      end
      within "#order-status" do
        expect(page).to have_content(@order_2.status)
      end
      within "#order-qty" do
        expect(page).to have_content(@order_2.count_of_items)
      end
      ...
      within "#order-item-#{@order_item_2.id}" do
        ...
        expect(page).to have_content(number_to_currency(@order_item_2.price / 100))
      ...
      within "#order-item-#{@order_item_3.id}" do
        ...
        expect(page).to have_content(number_to_currency(@order_item_3.price / 100))
