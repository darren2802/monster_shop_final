...
RSpec.describe 'Merchant Order Show Page' do
  describe 'As a Merchant' do
    before :each do
      ...
      @giant = @merchant_1.items.create!(name: 'Giant', description: "I'm a Giant!", price: 5000, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: true, inventory: 3 )
    ...
    it 'I can see order information with only my order items' do
      ...
      within "#order-item-#{@order_item_3.id}" do
        ...
        expect(page).to have_content(@order_item_3.price / 100)
