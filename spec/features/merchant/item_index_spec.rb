...
RSpec.describe 'Merchant Item Index' do
  describe 'As a Merchant employee' do
    before :each do
      ...
      @ogre = @merchant_1.items.create!(name: 'Ogre', description: "I'm an Ogre!", price: 2025, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: true, inventory: 5 )
      @nessie = @merchant_1.items.create!(name: 'Nessie', description: "I'm a Loch Monster!", price: 2025, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: true, inventory: 5 )
      @giant = @merchant_1.items.create!(name: 'Giant', description: "I'm a Giant!", price: 5000, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: false, inventory: 3 )
      @hippo = @merchant_2.items.create!(name: 'Hippo', description: "I'm a Hippo!", price: 5000, image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaLM_vbg2Rh-mZ-B4t-RSU9AmSfEEq_SN9xPP_qrA2I6Ftq_D9Qw', active: true, inventory: 1 )
    ...
    it 'I see my items, with statistics, including inactive items' do
      ...
      within "#item-#{@giant.id}" do
        ...
        expect(page).to have_content("Price: #{number_to_currency(@giant.price / 100)}")
      ...
      within "#item-#{@ogre.id}" do
        ...
        expect(page).to have_content("Price: #{number_to_currency(@ogre.price / 100)}")
